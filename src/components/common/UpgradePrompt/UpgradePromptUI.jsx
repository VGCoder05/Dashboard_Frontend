  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-2xl bg-surface rounded-xl shadow-custom-light overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary via-primary/90 to-subtle p-8 text-white">
          ...
          <p className="text-center text-white/90 font-display">
            ...
            <ul className="space-y-3">
              {features.map((feature, index) => (
                <li key={index} className="flex items-center group">
                  <div className="w-5 h-5 bg-gradient-to-br from-primary to-subtle rounded-full flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-gradient-to-br from-background to-border rounded-lg p-6 mb-6 border border-border">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-right">
                <p className="text-3xl font-display font-bold bg-gradient-to-r from-primary to-subtle bg-clip-text text-transparent">
                  ${pricing.price}
                </p>
                <p className="text-subtle font-display text-sm">/{pricing.period}</p>
              </div>
            </div>
